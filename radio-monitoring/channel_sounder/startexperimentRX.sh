#!/bin/bash
# Params: <transmitter> <receiver> <receiver_serial_number> <frequency> <channel>
...
export LOG_PREFIX="$1:$2:$3:$4:$5:$(date +%Y-%m-%d_%H_%M_%S)"

export PROFILE_DIR=$(pwd)
cd $PROFILE_DIR"/ProfileScripts"

# Params: <serial_number> <frequency> <channel> <gain_rx>
./Radio/Samples/startGNURadio-ChannelSounder-RX_v3.sh $3 $4 $5 $6
