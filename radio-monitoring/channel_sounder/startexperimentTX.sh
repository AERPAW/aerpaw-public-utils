#!/bin/bash
# Params: <transmitter> <transmitter_serial_number> <frequency> <channel>
...
export LOG_PREFIX="$1:$2:$3:$4:$(date +%Y-%m-%d_%H_%M_%S)"

export PROFILE_DIR=$(pwd)
cd $PROFILE_DIR"/ProfileScripts"

# Params: <serial_number> <frequency> <channel> <gain_tx>
./Radio/Samples/startGNURadio-ChannelSounder-TX_v3.sh $2 $3 $4 $5
